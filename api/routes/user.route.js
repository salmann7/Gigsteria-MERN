...
import { register, getUser, deleteUser, addFav, deleteFav, updateUser, addFollower, removeFollower, getUserDetail} from "../controllers/user.controller.js"
...
router.get("/", requireUser, getUserDetail);
